class ResourcesController < ApplicationController
  ...
  def teaching
    @resources = Resource.where(category: "teaching")
  end
  ...
  def writing
    @resources = Resource.where(category: "writing")
  end
  ...
  private
    ...
    def resource_params
      params.require(:resource).permit(:title, :description, :link, :category, :tags)
    end
end
